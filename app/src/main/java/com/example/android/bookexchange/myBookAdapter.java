...
public class myBookAdapter extends RecyclerView.Adapter<myBookAdapter.ViewHolder> {
    ...
    public myBookAdapter(Context context, List<Books> booksList) {
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.my_books_card, parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            bookImage = itemView.findViewById(R.id.my_book_card_image_view);
            semesterText = itemView.findViewById(R.id.my_book_card_branch);
            branchText = itemView.findViewById(R.id.my_book_card_semester);
            dateText = itemView.findViewById(R.id.my_book_card_date);
            bookCard = itemView.findViewById(R.id.my_book_card_card_view);
        }
    }
}
